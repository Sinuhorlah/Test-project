...
const ChangePin = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.button} onPress={() => router.push('/screen/MyCustomer"')}>
        <Text style={styles.buttonText}>Change Password</Text>
      </TouchableOpacity>

      <Text style={styles.success}> Password changed successfully. Please log in with your new password.</Text>
    </View>
  );
};
